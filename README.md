...
| Directory | Purpose |
|-----------|---------|
| `full_language_books/` | Machine-translated combined books (original formatting) |
| `reviewed_full_language_books/` | Human-edited versions from Google Docs (broken formatting) |
| `final_full_language_books/` | Final output with human edits + restored formatting |
...
1. Export your reviewed book from Google Docs and save to `reviewed_full_language_books/`
2. Run the fixer:

```bash
python chapter_fixer.py full_language_books/Swahili_Book.md reviewed_full_language_books/Swahili_Book.md final_full_language_books/Swahili_Book_Fixed.md
```
